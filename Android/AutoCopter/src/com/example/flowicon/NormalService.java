...
{	
	public static NormalService _currentService=null; 
	...
	public void onCreate()
	{
		...
		_logoutImageView=(ImageView)FlowIconSingleton._fullLayout.findViewById(R.id.logoutImageView);
		...
		_logoutImageView.setOnClickListener(TwoStateImageViewClickListener);

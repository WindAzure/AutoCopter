...
public abstract class SqlHelper
{
    ...
    /// 數據庫連接字符串
    /// </summary>
    public static readonly string _connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["DataBaseConnectionString"].ConnectionString.ToString().Trim();
